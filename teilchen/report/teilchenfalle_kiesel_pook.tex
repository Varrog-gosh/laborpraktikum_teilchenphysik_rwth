...
\end{table}
%Warun hast du die werte da rausgenommen?
...
Die Messungen wurden bei zwei verschiedenen Fokussierspannungen durchgeführt: $\unit[(1414±14)]{V}$ und $\unit[(500±14)]{V}$.
% amplitude der wehcselspannung noch mal kontrollieren
In beiden Konfigurationen wurden jeweils 4 Teilchen vermessen.
% in vakuum und in luft 4 teilcehn pro konfiguration = 16 teilchen?
