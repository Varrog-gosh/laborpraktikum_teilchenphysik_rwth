...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.5\textwidth]{E_t_aftercut.pdf}
	\includegraphics[width=0.5\textwidth]{E_t_aftercut_peak.pdf}
	\caption{$E_{T}$ Verteilung nach der Selektion. Die gesamte Verteilung (links) und ein Zoom auf das Maximum des Peak (rechts) }
