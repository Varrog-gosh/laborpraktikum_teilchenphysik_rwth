...
Die Simulierten Daten müssen um einen Vergleich mit den gemessenen Daten zu ermöglichen auf die gleiche
integrierte Luminosität $\mathcal{L}_{int}$ normiert werden. Dazu werden die Daten nach den Vorgaben aus \cite{versuchsanleitung},
...
\begin{align*}
	\epsilon = \frac{N_{selected}}{N_{gen}}
\end{align*}
...
als fehlerfrei. Der Wirkungsquerschnitt für die Reaktion $q+\bar{q}\rightarrow W \rightarrow e+ \nu$ lässt sich also bestimmen aus :
\begin{align*}
	\sigma = \frac{N_{selected}}{\epsilon \cdot corr \cdot \mathcal{L}_{int}}
\end{align*}
