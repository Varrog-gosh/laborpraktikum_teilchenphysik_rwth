...
% wo entsteht bei der hadronischen reaktion das neutrino?
...
% zu dem ganzen absatz: macht man das mit den veröffentlichungen wirklich so:
% "`in den [4] Zerfallskanlälen"' oder nicht lieber "` im LEP[4] Experiment wird w-> \dots
% bestimmt"' ? 
% ich finde es recht verwirrend, wenn die zahlen mit whitespaces rechts und link da stehen, ohne an
% ein wort gekoppelt zu sein. alternativ auch an satzende
