...
\begin{figure}[htb]
	\centering
	\includegraphics[width=.49\textwidth]{correlation.pdf}
	\includegraphics[width=.49\textwidth]{correlationmwt_el_et>1_7.pdf}
...
auch deutlich einen Unterschied  zwischen Simulation und Daten, der aber mit einem Schnitt bei
...
Zerfallskanälen $W+W \rightarrow qql\nu$ (semileptonsich) und $W+W \rightarrow qqqq\nu$(hadonisch) genutzt.  
...
\begin{itemize}
	...
	Abgesehen vom rein hadronischen Zerfallskanal bei LEP benutzen beide Experimente die gemesse Energie eines Elektron um die W-Masse zu bestimmen
	...
	Die Einflüsse dieser Fehlerquellen liegen bei LEP bei wenigen MeV und bei DØ ca. 70 MeV.
	...
	Bestimmung der Jrtenergie spielen diverse Faktoren wie die Wahl des Jet-Algorithmus,Pileup bei DØ(also Endzustände die in einer anderen Wechselwirkung
	...
	ca $\SI{65}{MeV}$ bei Do und $\SI{20}{MeV}$ bei LEP.
	...
	Unsicherheit auf die W Masse mit $\SI{35}{MeV}$ und LEP auf $\SI{20}{MeV}$ für den semi-leptonischen und $\SI{50}{MeV}$ für den hadronischen
	Zerfallskanal
