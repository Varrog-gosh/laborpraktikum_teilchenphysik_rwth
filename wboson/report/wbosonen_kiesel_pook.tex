...
\subsection{Verbessern der Selektionskriterien und Bestimmung der Fehler}
Da die Selektionsgrenzen recht willkürlich gesetzt werden und bis jetzt nur auf eine simulierte
Masse optimiert werden, kann es von nutzen sein, die Bestimmung der Selektionsgrenzen zu optimieren.
...
Beim Optimieren muss darauf geachtet werden, dass in den einzelnen Bins der Verteilung genug
Einträge sind (mehr als 9), damit man die poissonverteilten Einträge in eine Gaußverteilung 
...
Bereich. Im Allgemeinen steigen die Fehler auf die Masse mit der Anzahl Bins, wie man in Tabelle
\ref{tab:massenFehlerBin} sehen kann.
...
\begin{table}
	...
	\begin{tabular}{l|ccc}
		#Bins & 20 & 100 & 200\\
		\hline
		$σ_M [GeV]$ & 0.40 & 0.88 & 1.3
	\end{tabular}
	\caption{Steigend des Fehlers der Masse mit wachsender Anzahl Bins. Hier dient $m_T$ als
		Vergleichsgröße mit den Einschränkungen $\met>37 GeV$ und $E_{T} > 35 GeV$.}
	\label{tab:massenFehlerBin}
\end{table}

Da die Grenzen nur ungenau abgeschätzt werden, wird die Massenbestimmung noch mit $\SI{5}{GeV}$
verschobenen Grenzen durchgeführt. Man erhält aus den Werten in Tabelle \ref{tab:variation} ein
systematischen Fehler auf die Masse von $\SI{0.5}{GeV}$
