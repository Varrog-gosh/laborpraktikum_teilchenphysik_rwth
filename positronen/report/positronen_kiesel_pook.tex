...
%~ \end{table}
Als Ergebnis der Centroid Shift-Methode für die kurzlebige Komponente ergibt sich also:
\begin{align*}
...
\begin{figure}[h]
	\includegraphics[width=1.0\textwidth]{../analyse/final_plot_1.pdf}
	\caption{Zusammenfassung der Ergebnisse für $\tau_{1}$ }
	\label{fig:finalt1}
\end{figure}

\begin{figure}[h]
	\includegraphics[width=1.0\textwidth]{../analyse/final_plot_2.pdf}
