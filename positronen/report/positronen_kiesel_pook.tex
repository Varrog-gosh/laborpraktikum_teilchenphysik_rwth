...
\subsection{Bestimmung der Lebensdauern in Polyethylen}
	...
	der Entfaltung nicht stattfindet werden die Anpassungen zur langen Zerfallszeit $\tau_2$ an den ursprünglichen Daten durchgeführt, die Entfaltung zeigt jedoch, dass dieses Vorgehen gerechtfertigt ist.  
	Um die lange Halbwertszeit $\tau_2$ zu bestimmen wird in halblogarithmischer Darstellung eine Gerade angepasst, die Zerfallszeit lässt sich dann aus dem Kehrwert der Steigung berechnen:
	\begin{align*}
	\tau_2 =xx\pm xx \si{ns} 
	\end{align*}
	\begin{figure}
