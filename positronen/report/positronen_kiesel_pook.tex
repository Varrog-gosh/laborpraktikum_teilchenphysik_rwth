...
\subsection{Zeitnullpunkt,Zeitstabilität und experimentelle Zeitauflösung}\label{cap:kalibration}
\begin{figure}
...
beim Kaskadenzerfall in $^{60}$Co zwei zeitgleiche γ-Quanten mit Energien von $\SI{1.17}{MeV}$ und $\SI{1.33}{MeV}$. Es wird jeweils eine Messung vor Beginn
...
\begin{table}
	\begin{tabular}{l |l l ||l}
		...
		\hline
			&2.9 - 7.0& ( 1.758 ± 0.021 )&\\
			&2.9 - 6.0& ( 1.693 ± 0.025 ) ns
			&3.5 - 8& ( 1.923 ± 0.027 )

	\end{tabular}
	\centering
	\caption{Ergebnisse für die Lebensdauer von Positronen in Polyethylen mit zwei linearen
		Geradenanpassungen. Da die Werte nur knapp miteinander vereinbar sind, wird Mittelwert und
...
verlässt (siehe Abschnitt \ref{cap:kalibration}).
