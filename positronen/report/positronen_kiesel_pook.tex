...
$\frac{\text{Ereignisse}}{\text{Kanal}\cdot \text{Messdauer}}$. Die Bestimmung des Untergrunds wurde für beide
 ...
 \begin{table}[h]
	\begin{tabular}{l |l }
		$^{60}$Co  Messung & $\frac{\text{Ereignisse}}{\text{Kanal} \cdot \text{Messdauer}} [\si{Bq}]$ \\
		\hline
...
\begin{figure}
	\includegraphics[width=.5\textwidth]{linearFitpoly0.pdf}
	\includegraphics[width=.5\textwidth]{linearFitpoly1.pdf}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\textwidth]{../analyse/globalFitpoly2.pdf}
...
$τ_1$ wahrscheinlich genauer als das Ergebnis mit zwei linearen Fits.
...
\subsection{Zwei lineare Anpassungen}
\begin{figure}
	\includegraphics[width=.5\textwidth]{linearFitalu0.pdf}
	\includegraphics[width=.5\textwidth]{linearFitalu1.pdf}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\textwidth]{../analyse/globalFitalu2.pdf}
